...
urlpatterns = patterns(
        '',
        url(r'^teacher_dashboard/?$',
            'teacher_dashboard.views.dashboard_view', name='dashboard_view_handler'),
        ...
        url(r'^licenses/(?P<license_pk>[a-zA-Z0-9\-]+)/simulations/(?P<simulation_pk>[a-zA-Z0-9]+)/students/?$',
